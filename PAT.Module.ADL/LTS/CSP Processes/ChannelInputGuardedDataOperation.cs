...
{
    public sealed class ChannelInputGuardedDataOperation : Process
    {
        ...
        public ChannelInputGuardedDataOperation(string evtName, Expression index, Expression[] exp, Process process, Expression guard, Expression assignment, bool localvar)
        {
            ChannelName = evtName;            
            ExpressionList = exp;
            Process = process;
