...
{
    public abstract class CSPProcess  //: ProcessBase<Configuration>
    {
        ...
        /// <returns></returns>
        public abstract CSPProcess ClearConstant(Dictionary<string, Expression> constMapping);
        ...
        public virtual CSPProcess GetTopLevelConcurrency(List<string> visitedDef)
        {
            return null;
        }
