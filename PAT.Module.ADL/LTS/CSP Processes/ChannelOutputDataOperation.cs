...
{
    public sealed class ChannelOutputDataOperation : Process
    {
        ...
        public ChannelOutputDataOperation(string evtName, Expression index, Expression[] e, Process process, Expression assignment, bool localvar)
        {
            ChannelName = evtName;
            Process = process;
            ExpressionList = e;
        ...
        public override string ToString()
        {
            ...
            {
                return ChannelName + "!" + Common.Classes.Ultility.Ultility.PPStringListDot(ExpressionList).TrimStart('.') + "{" + AssignmentExpr + "}->"  + Process;
        ...
        public override Process ClearConstant(Dictionary<string, Expression> constMapping)
        {
            ...
            return new ChannelOutputDataOperation(ChannelName, ChannelIndex != null ? ChannelIndex.ClearConstant(constMapping) : ChannelIndex, newExpression, Process.ClearConstant(constMapping), AssignmentExpr.ClearConstant(constMapping), HasLocalVar);
        }
        ...
        public override Process Rename(Dictionary<string, Expression> constMapping, Dictionary<string, string> newDefNames, Dictionary<string, Definition> renamedProcesses)
        {
            ...
            Process result = new ChannelOutputDataOperation(ChannelName, ChannelIndex != null ? ChannelIndex.ClearConstant(constMapping) : ChannelIndex, newExpression, Process.Rename(constMapping, newDefNames, renamedProcesses), AssignmentExpr.ClearConstant(constMapping), HasLocalVar);
        ...
        public override void MakeDiscreteTransition(List<Expression> guards, List<Event> events, List<Expression> programBlocks, List<Process> processes, Model model, SymbolicLTS lts)
        {
            ...
            {
                List<Expression> guardUpdateChannel = AutomataBDD.GetGuardUpdateOfChannelOutput(this.ChannelName, new List<Expression>(ExpressionList), AssignmentExpr, model);
